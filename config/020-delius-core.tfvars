...
hmpps-delius-core-terraform = {
  ...
  delius-auto-test     = "2.13.1"
  delius-int           = "2.13.1"
  delius-mis-dev       = "2.13.1"
  delius-test          = "2.13.1"
  delius-po-test1      = "2.13.1"
  delius-perf          = "2.13.1"
  delius-stage         = "2.13.1"
  delius-training-test = "2.13.1"
...
delius-core-hmpps-env-configs = {
  # delius-core-dev      = "" # force to default to branch
  # delius-core-sandpit  = "" # force to default to branch
  delius-auto-test     = "1.191.0"
  delius-int           = "1.191.0"
  delius-mis-dev       = "1.191.0"
  delius-test          = "1.191.0"
  delius-po-test1      = "1.191.0"
  delius-perf          = "1.191.0"
  delius-stage         = "1.191.0"
  delius-training-test = "1.191.0"
  delius-training      = "1.191.0"
  delius-pre-prod      = "1.191.0"
