...
hmpps-delius-core-terraform = {
  ...
  delius-auto-test = "3.50.0"

  delius-int           = "3.50.0"
  delius-mis-dev       = "3.50.0"
  delius-test          = "3.50.0"
  delius-po-test1      = "3.50.0"
  delius-perf          = "3.50.0"
  delius-stage         = "3.50.0"
  delius-training-test = "3.50.0"
  delius-training      = "3.50.0"
  delius-pre-prod      = "3.50.0"
  delius-prod          = "3.46.0"
}
...
delius-core-hmpps-env-configs = {
  # delius-core-dev      = "" # force to default to branch
  # delius-core-sandpit  = "" # force to default to branch
  delius-auto-test = "1.560.0"

  delius-int           = "1.561.0"
  delius-mis-dev       = "1.561.0"
  delius-test          = "1.561.0"
  delius-po-test1      = "1.561.0"
  delius-perf          = "1.560.0"
  delius-stage         = "1.560.0"
  delius-training-test = "1.560.0"
  delius-training      = "1.560.0"
  delius-pre-prod      = "1.560.0"
  delius-prod          = "1.557.0"
}
