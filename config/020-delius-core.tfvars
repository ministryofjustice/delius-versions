...
hmpps-delius-core-terraform = {
  ...
  delius-auto-test = "3.87.0"

  delius-int           = "3.61.0"
  delius-mis-dev       = "3.88.0"
  delius-test          = "3.87.0"
  delius-po-test1      = "3.87.0"
  delius-perf          = "3.87.0"
  delius-stage         = "3.87.0"
  delius-training-test = "3.88.0"
  delius-training      = "3.87.0"
  delius-pre-prod      = "3.87.0"
  delius-prod          = "3.56.0"
}
...
delius-core-hmpps-env-configs = {
  # delius-core-dev      = "" # force to default to branch
  # delius-core-sandpit  = "" # force to default to branch
  delius-auto-test = "1.770.0"

  delius-int           = "1.663.0"
  delius-mis-dev       = "1.770.0"
  delius-test          = "1.770.0"
  delius-po-test1      = "1.770.0"
  delius-perf          = "1.770.0"
  delius-stage         = "1.770.0"
  delius-training-test = "1.770.0"
  delius-training      = "1.770.0"
  delius-pre-prod      = "1.770.0"
  delius-prod          = "1.648.0"
}
