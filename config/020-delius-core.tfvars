...
hmpps-delius-core-terraform = {
  ...
  delius-auto-test = "3.46.0"

  delius-int           = "3.48.0"
  delius-mis-dev       = "3.48.0"
  delius-test          = "3.46.0"
  delius-po-test1      = "3.46.0"
  delius-perf          = "3.46.0"
  delius-stage         = "3.46.0"
  delius-training-test = "3.46.0"
  delius-training      = "3.45.0"
  delius-pre-prod      = "3.45.0"
  delius-prod          = "3.45.0"
}
...
delius-core-hmpps-env-configs = {
  ...
  delius-training      = "1.556.0"
  delius-pre-prod      = "1.556.0"
  delius-prod          = "1.556.0"
}
