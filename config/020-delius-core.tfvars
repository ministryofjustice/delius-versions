...
hmpps-delius-core-terraform = {
  ...
  delius-training      = "3.48.0"
  delius-pre-prod      = "3.48.0"
  delius-prod          = "3.46.0"
}
...
delius-core-hmpps-env-configs = {
  # delius-core-dev      = "" # force to default to branch
  # delius-core-sandpit  = "" # force to default to branch
  delius-auto-test = "1.558.0"

  delius-int           = "1.559.0"
  delius-mis-dev       = "1.559.0"
  delius-test          = "1.558.0"
  delius-po-test1      = "1.558.0"
  delius-perf          = "1.559.0"
  delius-stage         = "1.558.0"
  delius-training-test = "1.559.0"
