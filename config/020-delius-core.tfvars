...
delius-core-hmpps-env-configs = {
  # delius-core-dev      = "" # force to default to branch
  # delius-core-sandpit  = "" # force to default to branch
  delius-auto-test = "1.445.0"

  delius-int           = "1.445.0"
  delius-mis-dev       = "1.445.0"
  delius-test          = "1.444.0"
  delius-po-test1      = "1.445.0"
  delius-perf          = "1.445.0"
  delius-stage         = "1.444.0"
  delius-training-test = "1.445.0"
  delius-training      = "1.444.0"
  delius-pre-prod      = "1.444.0"
  delius-prod          = "1.411.0"
}
