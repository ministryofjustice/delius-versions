...
hmpps-delius-network-terraform = {
  ...
  delius-training      = "1.25.0"
  delius-pre-prod      = "1.25.0"
  delius-prod          = "1.25.0"
}
...
delius-network-hmpps-env-configs = {
  # delius-core-dev      = "" # force to default to branch
  # delius-core-sandpit  = "" # force to default to branch
  delius-auto-test = "1.772.0"

  delius-int           = "1.713.0"
  delius-mis-dev       = "1.772.0"
  delius-test          = "1.765.0"
  delius-po-test1      = "1.772.0"
  delius-perf          = "1.766.0"
  delius-stage         = "1.772.0"
  delius-training-test = "1.765.0"
  delius-training      = "1.759.0"
  delius-pre-prod      = "1.759.0"
  delius-prod          = "1.759.0"
}
