...
hmpps-delius-network-terraform = {
  ...
  delius-auto-test = "1.31.0"

  delius-int           = "1.22.0"
  delius-mis-dev       = "1.31.0"
  delius-test          = "1.31.0"
  delius-po-test1      = "1.31.0"
  delius-perf          = "1.31.0"
  delius-stage         = "1.31.0"
  delius-training-test = "1.31.0"
  delius-training      = "1.31.0"
  delius-pre-prod      = "1.31.0"
  delius-prod          = "1.31.0"
}
...
delius-network-hmpps-env-configs = {
  # delius-core-dev      = "" # force to default to branch
  # delius-core-sandpit  = "" # force to default to branch
  delius-auto-test = "1.861.0"

  delius-int           = "1.713.0"
  delius-mis-dev       = "1.875.0"
  delius-test          = "1.866.0"
  delius-po-test1      = "1.866.0"
  delius-perf          = "1.861.0"
  delius-stage         = "1.866.0"
  delius-training-test = "1.861.0"
  delius-training      = "1.860.0"
  delius-pre-prod      = "1.861.0"
  delius-prod          = "1.860.0"
}
