...
hmpps-delius-network-terraform = {
  ...
  delius-auto-test = "1.25.0"

  delius-int           = "1.22.0"
  delius-mis-dev       = "1.25.0"
  delius-test          = "1.25.0"
  delius-po-test1      = "1.25.0"
  delius-perf          = "1.25.0"
  delius-stage         = "1.24.0"
  delius-training-test = "1.25.0"
  delius-training      = "1.24.0"
  delius-pre-prod      = "1.24.0"
  delius-prod          = "1.18.0"
}
...
delius-network-hmpps-env-configs = {
  # delius-core-dev      = "" # force to default to branch
  # delius-core-sandpit  = "" # force to default to branch
  delius-auto-test = "1.741.0"

  delius-int           = "1.713.0"
  delius-mis-dev       = "1.743.0"
  delius-test          = "1.741.0"
  delius-po-test1      = "1.741.0"
  delius-perf          = "1.741.0"
  delius-stage         = "1.739.0"
  delius-training-test = "1.742.0"
  delius-training      = "1.739.0"
  delius-pre-prod      = "1.739.0"
  delius-prod          = "1.548.0"
}
